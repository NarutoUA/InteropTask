========================================================================
    ACTIVE TEMPLATE LIBRARY : InteropCppCom Project Overview
========================================================================

AppWizard has created this InteropCppCom project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

InteropCppCom.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

InteropCppCom.vcxproj.filters
...
InteropCppCom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (InteropCppCom.h)
        GUID definitions                                (InteropCppCom_i.c)
        A type library                                  (InteropCppCom.tlb)
        Marshaling code                                 (InteropCppCom_p.c and dlldata.c)

InteropCppCom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in InteropCppCom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named InteropCppCom.pch and a precompiled types file named StdAfx.obj.
...
InteropCppComps.vcxproj
	...
	dlldata.c, InteropCppCom_i.c and InteropCppCom_p.c which are required
	to build the proxy/stub DLL.

InteropCppComps.vcxproj.filters
